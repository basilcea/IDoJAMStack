...
export default () => {
    return (<div className={serviceStyle.header}>
            ...
            <SingleService description={'Organized and efficent'} url={administrative} shortDetail={'Adminsitrative Support'}/>
            <SingleService description={'Your clients deserve quality service'} url={customerService} shortDetail={'Customer Service'}/>
            <SingleService description={'Fasten the process of turning data into insights'} url={dataEntry} shortDetail={'Data Entry'}/>
            </div>
        </div>)
}